...
# Attach the "docbox_office_converter_s3_access_policy" policy to the docbox role
...
# IAM Policy to allow invoking the office converter lambda
resource "aws_iam_policy" "docbox_office_converter_invoke" {
  name        = "docbox_office_converter_invoke_policy"
...
# Attach the "docbox_office_converter_invoke" policy to the docbox role
